...
def main(c, mn):
    ...
    S_2021, conn_sink_2021, block_20_2021 = MobileRelay.get_distance_to_sink(S_2021, len(c), block_2)
    S_2021, conn_segm_2021, block_20_2021 = MobileRelay.get_distance_to_segm(S_2021, len(c), block_20_2021)
    block_20_2021 = MobileRelay.get_plumpness(block_20_2021)
    cost_2021, conn_path_selected_2021 = MobileRelay.get_move_cost(S_2021, len(c), block_20_2021, conn_sink_2021)
